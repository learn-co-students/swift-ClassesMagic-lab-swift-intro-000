...
//                    expect(dealer.deck).to(beTruthy() as! Predicate<Deck>)
//                }
//
//                it("should create the house") {
//                    expect(dealer.house).to(beTruthy() as! Predicate<House>)
//                }
//
//                it("should create a player") {
//                    expect(dealer.player).to(beTruthy() as! Predicate<Player>)
//                }
//            }
//
//            describe("placeBet") {
//                it("should return true if both the house and the player can afford the bet") {
//                    expect(dealer.placeBet(10)).to(equal(true) as! Predicate<()>)
